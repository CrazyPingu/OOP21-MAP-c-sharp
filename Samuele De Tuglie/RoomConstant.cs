namespace Utilities
{
    public class RoomConstant
    {
        ...
        public static SimpleEnemy SearchEnemy((int, int) pos, List<SimpleEnemy> enemyList)
        {
        ...
        public static Artefact SearchArtefact((int, int) pos, List<Artefact> artefactList)
        {
